...
const filterNullForProperty = (data, property) => {
	return data.filter((passenger) => passenger.fields[property] != null)
}
...
const sumAllProperty = (data, property) => {
	const filtered = data.filter((passenger) => passenger.fields[property] != null)
	const properties = filtered.map((passenger) => passenger.fields[property])
	return properties.reduce((acc, val) => acc + val)
}
...
const countAllProperty = (data, property) => {
	const hist = {}
	const passengers = data.filter((passenger) => passenger.fields[property] !== null)
...
const makeHistogram = (data, property, step) => {
	const passengers = data.filter((passenger) => passenger.fields[property] !== undefined)
